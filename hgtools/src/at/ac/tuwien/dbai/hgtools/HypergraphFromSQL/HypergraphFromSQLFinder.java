 ...
 */
public class HypergraphFromSQLFinder implements SelectVisitor, FromItemVisitor, ExpressionVisitor, ItemsListVisitor, SelectItemVisitor, StatementVisitor {
    ...
    public Map<String,String> getTableList(Expression expr) {
        init();
        expr.accept(this);
        return tables;
    }
    ...
    public void visit(Table tableName) {
        ...
        if (!otherItemNames.contains(tableWholeName.toLowerCase())
                && !tables.containsKey(tableAliasName)) {
    ...
    public void visit(EqualsTo equalsTo) {
    	if (equalsTo.getLeftExpression() instanceof Column && 
    	    equalsTo.getRightExpression() instanceof Column) {
    		   ...
    		   sc.setA((Column)equalsTo.getLeftExpression());
    		   sc.setB((Column)equalsTo.getRightExpression());
    		   joins.add(sc);
    	} else
